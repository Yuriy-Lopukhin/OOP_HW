...
public class BookingView implements View {
    ...
    public void showReservationTableExchangeResult(int reservationId){
    ...
    public void changeReservationTable(int oldReservationTable, Date reservationDate, int tableNo, String name){
        //TO DO: Необходимо обратиться к наблюдателю ...
        observer.changeReservationTable(oldReservationTable, reservationDate, tableNo, name);
    }
